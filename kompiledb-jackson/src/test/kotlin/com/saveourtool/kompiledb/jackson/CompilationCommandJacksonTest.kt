 ...
 */
class CompilationCommandJacksonTest {
    ...
    fun `extra fields when reading`() {
        ...
        val failure = with(jsonIo) {
            json.toCompilationCommand()
        }.shouldBeFailure<MismatchedInputException>()

        failure.message.shouldNotBeNull() shouldStartWith
                """4 unexpected field(s) encountered (extra1, extra2, extra3, extra4)"""
    }
